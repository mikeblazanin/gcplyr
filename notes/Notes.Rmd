...
mSystems?
mBio?
mSphere - explicitly has a Resource Reports article type, maybe if I have to
          write a bunch for dissertation anyways?
...
8. Re-knit README.Rmd
9. Save & commit newly generated README.md file
...
15. Update DESCRIPTION to development version number (add .9000 at end of previous version)
16. Add new release on GitHub
