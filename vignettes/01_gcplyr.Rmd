...
```{r, include = FALSE}
#Generate our example data files
make_example(vignette = 1, example = 1, dir = "./example_data")

#Generate our example design files
make_example(vignette = 1, example = 2, dir = "./example_data")
```
