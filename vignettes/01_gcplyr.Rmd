...
Users often want to combine their data with some information on the experimental design of their plate(s). You can save this information into a tabular file as well, or you can just keep it handy to enter directly in `R` (see `vignette("03_incorporate_designs")`).
...
data_filename <- make_example(vignette = 1, example = 1, dir = ".")

#Generate our example design files, Bacteria_strain.csv and Phage.csv
design_filenames <- make_example(vignette = 1, example = 2, dir = ".")

# Read in our data 
data_wide <- read_wides(files = data_filename)
...
# Import our designs
designs <- import_blockdesigns(files = design_filenames)
