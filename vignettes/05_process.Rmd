...
2. fit the growth dynamics with a mathematical model, then extract parameters from the fitted model - check out the **Other growth curve analysis packages** section in vignette("08_conclusion") if you're interesting in exploring this approach
