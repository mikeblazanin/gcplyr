...
```{r}
mean_blank <- mean(dplyr::filter(ex_dat_mrg, Well_type == "Blank"))

ex_dat_mrg$Meas_norm <- ex_dat_mrg$Measurements - mean_blank
```

Note that if you have different blanks for different wells (e.g. you have multiple medias), you'll have to calculate different blank values for each:
