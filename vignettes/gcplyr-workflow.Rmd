...
What do you do if you have multiple design components? For instance, what if you have several different bacterial strains each grown in several different treatments? In that case, simply save each design component as a separate file, and import them all in one go with `import_blockdesigns`.
...
There is! We can see that the antibiotic resistant strains (`TRUE`) have a smaller area-under-the-curve than the antibiotic sensitive strains (`FALSE`).
