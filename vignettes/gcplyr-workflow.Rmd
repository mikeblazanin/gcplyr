...
example_data_and_designs$Measurements <-
  example_data_and_designs$Measurements * 
  runif(nrow(example_data_and_designs), min = 0.9, max = 1.1)
...
If you've previously smoothed your absorbance data, make sure to use those smoothed values rather than the original values!
...
#Now let's plot the absorbance and the derivative
plot(example_data_and_designs$Time[
  example_data_and_designs$Well == "A2"],
     example_data_and_designs$smoothed[
       example_data_and_designs$Well == "A2"],
...
#Now let's plot the absorbance and the per-capita derivative
plot(example_data_and_designs$Time[
  example_data_and_designs$Well == "A2"],
     example_data_and_designs$smoothed[
       example_data_and_designs$Well == "A2"],
...
If, instead of derivatives, you simply want the difference between each time-step, you can set `scale_x = NA` (in which case, you also don't need to provide the x values). (This looks very similar to our original derivative plot because in the example data all timesteps are equally long)
