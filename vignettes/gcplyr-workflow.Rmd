...
If you find it easier to input the pattern as a vector rather than as a string that needs to be split, you can do that too:
...
Additionally, there are some `R` packages that don't implement fitting-style approaches, but contain useful functionality for plate-reader data analysis:
