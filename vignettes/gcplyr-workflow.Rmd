...
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
     ex_dat_mrg$Measurements[ex_dat_mrg$Well == "A1"],
     xlab = "time", ylab = "Abs")
```
...
```{r}
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
     log10(ex_dat_mrg$Measurements[ex_dat_mrg$Well == "A1"]),
...
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
     log10(ex_dat_mrg$Measurements[ex_dat_mrg$Well == "A1"]),
     xlab = "time", ylab = "log10(Abs)")
lines(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
      log10(ex_dat_mrg$smoothed3[ex_dat_mrg$Well == "A1"]),
      col = "gray20")
lines(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
      log10(ex_dat_mrg$smoothed7[ex_dat_mrg$Well == "A1"]),
      col = "gray45")
lines(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
      log10(ex_dat_mrg$smoothed11[ex_dat_mrg$Well == "A1"]),
      col = "gray65")
```
...
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
     ...
     xlab = "time", ylab = "log10(Abs)")
lines(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
      log10(ex_dat_mrg$smoothed1[ex_dat_mrg$Well == "A1"]),
      col = "gray20")
lines(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
      log10(ex_dat_mrg$smoothed2[ex_dat_mrg$Well == "A1"]),
      col = "gray45")
lines(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
      log10(ex_dat_mrg$smoothed5[ex_dat_mrg$Well == "A1"]),
      col = "gray65")
```
...
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
  ...
  xlab = "time", ylab = "log10(Abs)")
lines(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
  log10(ex_dat_mrg$smoothed20[ex_dat_mrg$Well == "A1"]),
  col = "gray20")
lines(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
  log10(ex_dat_mrg$smoothed10[ex_dat_mrg$Well == "A1"]),
  col = "gray45")
lines(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
  log10(ex_dat_mrg$smoothed5[ex_dat_mrg$Well == "A1"]),
  col = "gray65")
...
ex_dat_mrg$smoothed <-
  smooth_data(x = ex_dat_mrg$Time, y = ex_dat_mrg$smoothed,
              method = "gam", subset_by = ex_dat_mrg$Well, k = 40)
...
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
     ...
     xlab = "time", ylab = "log10(Abs)")
lines(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
      log10(ex_dat_mrg$smoothed[ex_dat_mrg$Well == "A1"]))
```
...
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
     ex_dat_mrg$deriv[ex_dat_mrg$Well == "A1"],
...
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
     ex_dat_mrg$deriv_percap[ex_dat_mrg$Well == "A1"],
...
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
     ex_dat_mrg$deriv_percap_hr[ex_dat_mrg$Well == "A1"],
...
Here, we calculate the area-under-the-curve of the density data (saved to the `auc` column)
...
```{r}
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A7"],
     ex_dat_mrg$Measurements[ex_dat_mrg$Well == "A7"],
     xlab = "time", ylab = "Abs")
lines(ex_dat_mrg$Time[ex_dat_mrg$Well == "A7"],
      ex_dat_mrg$smoothed[ex_dat_mrg$Well == "A7"])

#On log axes
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A7"],
     log10(ex_dat_mrg$Measurements[ex_dat_mrg$Well == "A7"]),
     xlab = "time", ylab = "log10(Abs)")
lines(ex_dat_mrg$Time[ex_dat_mrg$Well == "A7"],
      log10(ex_dat_mrg$smoothed[ex_dat_mrg$Well == "A7"]))
```
...
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A7"],
     ex_dat_mrg$deriv_percap_hr[ex_dat_mrg$Well == "A7"],
     xlab = "time", ylab = "per-capita growth rate (/hr)",
     main = "all data")

#What do subsets look like with OD cutoffs of 0.001, 0.005, and 0.01?
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A7"  & ex_dat_mrg$smoothed > 0.001],
     ex_dat_mrg$deriv_percap_hr[
       ex_dat_mrg$Well == "A7"  & ex_dat_mrg$smoothed > 0.001],
     xlab = "time", ylab = "per-capita growth rate (/hr)",
     main = "data where OD > 0.001")

plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A7"  & ex_dat_mrg$smoothed > 0.005],
     ex_dat_mrg$deriv_percap_hr[
       ex_dat_mrg$Well == "A7"  & ex_dat_mrg$smoothed > 0.005],
     xlab = "time", ylab = "per-capita growth rate (/hr)",
     main = "data where OD > 0.005")

plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A7"  & ex_dat_mrg$smoothed > 0.01],
     ex_dat_mrg$deriv_percap_hr[
       ex_dat_mrg$Well == "A7"  & ex_dat_mrg$smoothed > 0.01],
     xlab = "time", ylab = "per-capita growth rate (/hr)",
...
```{r}
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
     ex_dat_mrg$smoothed[ex_dat_mrg$Well == "A1"],
     xlab = "time", ylab = "Smoothed Absorbance", main = "Well A1")
points(x = ex_dat_mrg_sum$first_peak_x[ex_dat_mrg_sum$Well == "A1"],
       y = ex_dat_mrg_sum$first_peak_y[ex_dat_mrg_sum$Well == "A1"],
       pch = 16, cex = 2)
```
...
points(x = ex_dat_mrg_sum$first_peak_x[ex_dat_mrg_sum$Well == "A7"],
       y = ex_dat_mrg_sum$first_peak_y[ex_dat_mrg_sum$Well == "A7"],
       pch = 16, cex = 2)
```
...
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
     ex_dat_mrg$deriv[ex_dat_mrg$Well == "A1"],
     xlab = "time", ylab = "derivative (Absorbance/sec)")
abline(v = ex_dat_mrg_sum$diauxie_x[ex_dat_mrg_sum$Well == "A1"])
```
...
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
     ex_dat_mrg$smoothed[ex_dat_mrg$Well == "A1"],
     xlab = "time", ylab = "Smoothed Absorbance", main = "Well A1")
points(x = ex_dat_mrg_sum$diauxie_x[ex_dat_mrg_sum$Well == "A1"],
       y = ex_dat_mrg_sum$diauxie_dens[ex_dat_mrg_sum$Well == "A1"],
       pch = 16, cex = 2)
```
...
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
     ...
     xlab = "time", ylab = "per-capita growth rate (/hr)",
     main = "Well A1")
points(x = ex_dat_mrg_sum$diauxie_percap_time[ex_dat_mrg_sum$Well == "A1"],
       y = ex_dat_mrg_sum$diauxie_percap[ex_dat_mrg_sum$Well == "A1"],
       pch = 16, cex = 2)
```
...
Let's take a look at an example. Well A7 has bacteria and phages in it, let's look at the *smoothed* absorbance values:

```{r}
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A7"],
     ex_dat_mrg$smoothed[ex_dat_mrg$Well == "A7"],
     xlab = "time", ylab = "Absorbance",
     main = "Well A7")
```
...
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A7"],
     ...
     xlab = "time", ylab = "Absorbance",
     main = "Well A7")
points(x = ex_dat_mrg_sum$extin_time[ex_dat_mrg_sum$Well == "A7"],
       y = 0.15, pch = 16, cex = 2)
```

As we can see, the plots of the curves with no phage added tend to never drop below 0.15 once they've passed it. That's good! That's what we'd expect. In contrast, the phage-added wells all have a time when the bacteria drop below that threshold, and the plot clearly shows that it's right where we'd expect it.
...
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
     ...
     xlab = "time", ylab = "Absorbance",
     main = "Well A1")
points(x = ex_dat_mrg_sum$time_to_01[ex_dat_mrg_sum$Well == "A1"],
       y = 0.1, pch = 16, cex = 2)
points(x = ex_dat_mrg_sum$time_to_05[ex_dat_mrg_sum$Well == "A1"],
       y = 0.5, pch = 16, cex = 2)
```
As we can see, `find_threshold_crosses` has returned the times when the bacteria reached those densities. We can see that some bacteria (e.g. those in Well A7) never reached 0.5, but all of the ones shown by `head` *did* reach 0.1. By comparing the times it took each strain to reach an absorbance of 0.1, we could learn something about how soon the bacteria started growing and how quickly they grew.
