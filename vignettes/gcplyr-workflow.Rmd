...
plot(
  ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
...
ex_dat_mrg$smoothed3 <-
  smooth_data(x = ex_dat_mrg$Time,
              y = ex_dat_mrg$Measurements,
...
lines(
  ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
  log10(
    ex_dat_mrg$smoothed3[ex_dat_mrg$Well == "A1"]),
  col = "gray20")
lines(
  ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
  log10(
    ex_dat_mrg$smoothed7[ex_dat_mrg$Well == "A1"]),
  col = "gray45")
lines(
  ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
  log10(
    ex_dat_mrg$smoothed11[ex_dat_mrg$Well == "A1"]),
  col = "gray65")
```
...
lines(
  ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
  log10(
    ex_dat_mrg$smoothed1[ex_dat_mrg$Well == "A1"]),
  col = "gray20")
lines(
  ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
  log10(
    ex_dat_mrg$smoothed2[ex_dat_mrg$Well == "A1"]),
  col = "gray45")
lines(
  ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
  log10(
    ex_dat_mrg$smoothed5[ex_dat_mrg$Well == "A1"]),
  col = "gray65")
```
...
lines(
  ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
  log10(
    ex_dat_mrg$smoothed20[ex_dat_mrg$Well == "A1"]),
  col = "gray20")
lines(
  ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
  log10(
    ex_dat_mrg$smoothed10[ex_dat_mrg$Well == "A1"]),
  col = "gray45")
lines(
  ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
  log10(
...
#What does the smoothed data look like compared to the noisy original?
plot(
  ex_dat_mrg$Time[ex_dat_mrg$Well == "A7"],
...
points(
  x = ex_dat_mrg_sum$first_peak_x[
    ex_dat_mrg_sum$Well == "A1"],
  y = ex_dat_mrg_sum$first_peak_y[
    ex_dat_mrg_sum$Well == "A1"],
  pch = 16, cex = 2)
```
...
plot(ex_dat_mrg$Time[ex_dat_mrg$Well == "A1"],
  ...
  xlab = "time", ylab = "Smoothed Absorbance", main = "Well A1")
points(
  x = ex_dat_mrg_sum$diauxie_x[
    ex_dat_mrg_sum$Well == "A1"],
  y = ex_dat_mrg_sum$diauxie_dens[
    ex_dat_mrg_sum$Well == "A1"],
  pch = 16, cex = 2)
```
...
plot(
  ...
  main = "Well A1")
points(
  x = ex_dat_mrg_sum$diauxie_percap_time[
    ex_dat_mrg_sum$Well == "A1"],
  y = ex_dat_mrg_sum$diauxie_percap[
    ex_dat_mrg_sum$Well == "A1"],
  pch = 16, cex = 2)
```
...
```{r}
ex_dat_mrg_sum <-
  dplyr::filter(ex_dat_mrg_sum, Phage == "No Phage")
head(ex_dat_mrg_sum)
```
...
```{r}
growth_and_antibiotics <- merge_dfs(ex_dat_mrg_sum,
                                    antibiotic_dat)
