...
ex_dat_mrg$smoothed1 <-
  smooth_data(x = ex_dat_mrg$Time, y = ex_dat_mrg$Measurements,
              sm_method = "loess", subset_by = ex_dat_mrg$Well,
              span = .1, degree = 1)
...
ex_dat_mrg$smoothed20 <-
  smooth_data(x = ex_dat_mrg$Time, y = ex_dat_mrg$Measurements,
              sm_method = "gam", subset_by = ex_dat_mrg$Well, k = 20)
ex_dat_mrg$smoothed10 <-
  smooth_data(x = ex_dat_mrg$Time, y = ex_dat_mrg$Measurements,
              sm_method = "gam", subset_by = ex_dat_mrg$Well, k = 10)
ex_dat_mrg$smoothed5 <-
  smooth_data(x = ex_dat_mrg$Time, y = ex_dat_mrg$Measurements,
              sm_method = "gam", subset_by = ex_dat_mrg$Well, k = 5)
