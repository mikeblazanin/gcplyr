...
# Transforming data
Now that you've gotten your data into the R environment, we need to transform it before we can do analyses. To reiterate, this is necessary because most equipment that generates growth curves data outputs in block-shaped or wide-shaped files, but tidy-shaped data.frames are the best shape for analyses.
