...
As we can see, the wells with no phage added tend to never drop below 0.15 once they've passed it. That's what we'd expect! In contrast, the phage-added wells all have a time when the bacteria drop below that threshold, and the plot clearly shows that it's right where we'd expect it.
