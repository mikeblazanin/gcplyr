...
With your data and design information merged, **your dataset is now organized in a way that's easy to export and analyze**. It is also at this point that the next steps for what you can do diversify into many options.
...
example_data_and_designs$Time <- time_length(hms(example_data_and_designs$Time))
...
Let's take a look at one well from our example data, which is already a little noisy.

```{r}
#What does one well of our (noisy) data look like?
plot(
  example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  example_data_and_designs$Measurements[example_data_and_designs$Well == "A1"],
  xlab = "time", ylab = "Abs")
```
...
* `gam` is also a spline-fitting approach that tends to better avoid the creation of curvature artifacts and is often recommended over loess, although you should evaluate its efficacy for your own data
...
```{r}
example_data_and_designs$smoothed3 <-
  smooth_data(x = example_data_and_designs$Time,
              ...
              window_width_n = 3)
example_data_and_designs$smoothed7 <-
  smooth_data(x = example_data_and_designs$Time,
              y = example_data_and_designs$Measurements,
              method = "moving-average",
              subset_by = example_data_and_designs$Well,
              window_width_n = 7)
example_data_and_designs$smoothed11 <-
  smooth_data(x = example_data_and_designs$Time,
              y = example_data_and_designs$Measurements,
              method = "moving-average",
              subset_by = example_data_and_designs$Well,
...
#Darker lines are wider window_width_n's and more "smoothed"
plot(
  example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  example_data_and_designs$Measurements[example_data_and_designs$Well == "A1"],
  xlab = "time", ylab = "Abs")
lines(
  example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  example_data_and_designs$smoothed3[example_data_and_designs$Well == "A1"],
  col = "gray20")
lines(
  example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  example_data_and_designs$smoothed7[example_data_and_designs$Well == "A1"],
  col = "gray45")
lines(
  example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  example_data_and_designs$smoothed11[example_data_and_designs$Well == "A1"],
  col = "gray65")

#What does the smoothing look like on log axes?
plot(
  example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  log10(
    example_data_and_designs$Measurements[example_data_and_designs$Well == "A1"]),
...
```{r}
example_data_and_designs$smoothed1 <-
  smooth_data(x = example_data_and_designs$Time,
              y = example_data_and_designs$Measurements,
              method = "loess",
              subset_by = example_data_and_designs$Well,
              span = .1, degree = 1)
example_data_and_designs$smoothed2 <-
  smooth_data(x = example_data_and_designs$Time,
              y = example_data_and_designs$Measurements,
              method = "loess",
              subset_by = example_data_and_designs$Well,
              span = .2, degree = 1)
example_data_and_designs$smoothed5 <-
  smooth_data(x = example_data_and_designs$Time,
              y = example_data_and_designs$Measurements,
              method = "loess",
              subset_by = example_data_and_designs$Well,
...
lines(
  example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  example_data_and_designs$smoothed1[example_data_and_designs$Well == "A1"],
  col = "gray20")
lines(
  example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  example_data_and_designs$smoothed2[example_data_and_designs$Well == "A1"],
  col = "gray45")
lines(
  example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  example_data_and_designs$smoothed5[example_data_and_designs$Well == "A1"],
  col = "gray65")
...
lines(
  example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  example_data_and_designs$smoothed20[example_data_and_designs$Well == "A1"],
  col = "gray20")
lines(
  example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  example_data_and_designs$smoothed10[example_data_and_designs$Well == "A1"],
  col = "gray45")
lines(
  example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  example_data_and_designs$smoothed5[example_data_and_designs$Well == "A1"],
...
Here we can see that `gam` with higher `k` (darkest line) have smoothed the data but are still sensitive to those early outliers. However, `gam` with lower `k` values (lighter lines) have introduced significant bias, with the smallest `k` (lightest line) overestimating early data and adding fluctuations to later data points. To fix this, we might explore other smoothing methods or combining `gam` with other smoothing methods.

### Combining multiple smoothing methods

Often, combining multiple smoothing methods can provide improved results. For instance, `moving-median` is particularly good at removing outliers, but not very good at producing continuously smooth data. In contrast, `loess`, and `gam` work well at producing continuously smooth data, but aren't as good at removing outliers. Here's an example using `moving-median` and `gam` (note that because `moving-median` removes the outliers, we can use `gam` with even less smoothing than before):
...
example_data_and_designs$smoothed <-
  smooth_data(x = example_data_and_designs$Time,
              ...
              subset_by = example_data_and_designs$Well,
              window_width_n = 3)
#Note that for the second smoothing, we're using the first smoothing results
# as input
example_data_and_designs$smoothed <-
  smooth_data(x = example_data_and_designs$Time,
...
lines(
  example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  example_data_and_designs$smoothed[example_data_and_designs$Well == "A1"])
...
lines(
  example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  log10(example_data_and_designs$smoothed[example_data_and_designs$Well == "A1"]))
```

Here we can see that the combination of minimal `moving-median` and minimal `gam` smoothing has produced a curve that is very smooth (and so good for downstream analyses) but has minimal introduction of bias.
...
plot(example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
     example_data_and_designs$deriv[example_data_and_designs$Well == "A1"],
  xlab = "time", ylab = "derivative (Absorbance/sec)")
```

Here we can clearly see when the slope of the total population was increasing the fastest. But we can also see something that may not have been immediately apparent visually: there is a second, slower, burst of growth later on. Such a pattern is common in bacterial growth curves and is called *diauxic growth*.
...
plot(example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
     example_data_and_designs$deriv_percap[example_data_and_designs$Well == "A1"],
  xlab = "time", ylab = "per-capita growth rate (/sec)")
```

Here we can see that the per-capita growth rate peaked much earlier in the time-series than might appear from the density dynamics or non per-capita derivative. We can also see that there was clearly a lag phase at the beginning before the bacteria started growing rapidly.
...
```{r}
example_data_and_designs$deriv_percap_hr <-
  calc_deriv(x = example_data_and_designs$Time,
             y = example_data_and_designs$smoothed,
             subset_by = example_data_and_designs$Well,
             percapita = TRUE, blank = 0,
...
plot(example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
     example_data_and_designs$deriv_percap_hr[example_data_and_designs$Well == "A1"],
  xlab = "time", ylab = "per-capita growth rate (/hr)")
```

Now we can see the bacterial growth rate in more-understandable units: they're growing just over 1.5 times/hour.
...
* the peak per-capita growth rate during a diauxic shift
...
`gcplyr` contains a number of functions that make it easier to carry out these calculations, and many others that you might wish to design yourself. In the following sections, we highlight general-use `gcplyr` functions and provide examples using the common metrics above. 

But first, we need to familiarize ourselves with the `dplyr` package and its functions `group_by` and `summarize`. Why? Because the upcoming `gcplyr` functions need to be used *within* `dplyr::summarize`. **If you’re already familiar with `dplyr`, feel free to skip to the [Calculating lag time and maximum growth rate] section.** If you’re not familiar yet, don’t worry! Continue to the next section, where we provide a primer that will teach you all you need to know on using `group_by` and `summarize`.
...
For growth curves, this means we will `group_by` our data so that every well is a group, and then we'll `summarize` each well with calculations like maximum density or area under the curve. Since `dplyr` will drop any columns that the data aren't grouped by, we will typically want to list all of our design columns for `group_by`, along with the plate name and well. Make sure you're *not* grouping by Time, Absorbance, or anything else that varies *within* a well, since if you do `dplyr` will group timepoints within a well separately.

In the next section, we provide a simple example of how the `max` function is used with `group_by` and `summarize` to calculate lag time and the maximum per-capita growth rate. If you want to learn more, `dplyr` has extensive documentation and examples of its own online. Feel free to explore them as desired, but this primer and the coming example should be sufficient to use the remaining `gcplyr` functions, which (again) have to be used *within* `summarize` to work correctly.
...
Notice that this hasn't changed anything about our `data.frame`, but the groups are saved in there under the hood. Then, we run `summarize`, specifying the name we want to save the results to and the function that calculates the summarized results. For instance, in the code below we've calculated the maximum of the `smoothed` column, and saved it in a column named `max_dens` (note that we need to specify `na.rm = TRUE` to tell `max` to ignore all `NA` values).
...
If you want additional characteristics, you simply add them to the summarize. For instance, if we want the minimum density, you just add that as a second argument, here saved in a column named `min_dens`:

```{r}
example_data_and_designs_sum <-
  summarize(grouped_example_data_and_designs,
            max_dens = max(smoothed, na.rm = TRUE),
            min_dens = min(smoothed, na.rm = TRUE))
head(example_data_and_designs_sum)
```
...
Here, we calculate the area-under-the-curve of the density data (saved to the `auc` column), as well as the area-under-the-curve beginning after 3 hours (10800 seconds, saved to the `auc_after3hrs` column)
...
## Summarizing on subsets: lag time and maximum growth rate

Sometimes, we need to provide limits on the data our simple functions will work with. We can demonstrate this in the process of calculating two common metrics we want to identify: 

* the lag time (here we'll use the delay from the start of the run until growth rate peaks as a measure of lag time)
* the maximum per-capita growth rate. 

Let's take a look at how this might work. What happens if we just try to use `max` on our per-capita growth rates?

```{r}
example_data_and_designs_sum <-
  summarize(grouped_example_data_and_designs,
            growth_rate = max(deriv_percap_hr, na.rm = TRUE))
head(example_data_and_designs_sum)
```

Hmm, some of those values seem really extreme. Let's take a peek at what's happening, for instance in Well A7

```{r}
#What does the smoothed data look like compared to the noisy original?
plot(
  example_data_and_designs$Time[example_data_and_designs$Well == "A7"],
  example_data_and_designs$Measurements[example_data_and_designs$Well == "A7"],
  xlab = "time", ylab = "Abs")
lines(
  example_data_and_designs$Time[example_data_and_designs$Well == "A7"],
  example_data_and_designs$smoothed[example_data_and_designs$Well == "A7"])
...
lines(
  example_data_and_designs$Time[example_data_and_designs$Well == "A7"],
  log10(example_data_and_designs$smoothed[example_data_and_designs$Well == "A7"]))
```

Ahh, our smoothing has dipped into the negative territory, which is causing our per-capita growth rate to go haywire. We could try going back and adjusting our smoothing, but because so much of our data is so close to 0 we're unlikely to have much success. What if we just exclude all the values when the density is really low? Since all those values are basically just random noise from when the bacterial densities were really low, excluding them doesn't mean we're losing any information.

Let's plot our per-capita growth rates at different cutoffs:

```{r}
#What does the original per-capita growth rate over time look like?
plot(
  example_data_and_designs$Time[example_data_and_designs$Well == "A7"],
  example_data_and_designs$deriv_percap_hr[
    example_data_and_designs$Well == "A7"],
  xlab = "time", ylab = "per-capita growth rate (/hr)",
  main = "all data")

#What do subsets look like with cutoffs of 0.001, 0.005, and 0.01?
plot(
  example_data_and_designs$Time[
    example_data_and_designs$Well == "A7"  &
      example_data_and_designs$smoothed > 0.001],
  example_data_and_designs$deriv_percap_hr[
    example_data_and_designs$Well == "A7"  &
      example_data_and_designs$smoothed > 0.001],
  xlab = "time", ylab = "per-capita growth rate (/hr)",
  main = "data where OD > 0.001")


plot(
  example_data_and_designs$Time[
    example_data_and_designs$Well == "A7"  &
      example_data_and_designs$smoothed > 0.005],
  example_data_and_designs$deriv_percap_hr[
    example_data_and_designs$Well == "A7"  &
      example_data_and_designs$smoothed > 0.005],
  xlab = "time", ylab = "per-capita growth rate (/hr)",
  main = "data where OD > 0.005")

plot(
  example_data_and_designs$Time[
    example_data_and_designs$Well == "A7"  &
      example_data_and_designs$smoothed > 0.01],
  example_data_and_designs$deriv_percap_hr[
    example_data_and_designs$Well == "A7"  &
      example_data_and_designs$smoothed > 0.01],
  xlab = "time", ylab = "per-capita growth rate (/hr)",
  main = "data where OD > 0.01")

```

We can see with a cutoff of 0.001, many high growth rate points that are basically noise still remain. However, once we use a cutoff of 0.005, they are all basically gone, and no high growth rate values are affected by 0.005 vs 0.01. If we checked this pattern for other wells, we would see a similar result. **Now, let's calculate the maximum growth rate of just the subset** of data points where OD is above 0.005. We can specify that subset directly in the summarize command:

```{r}
example_data_and_designs_sum <-
  summarize(grouped_example_data_and_designs,
            growth_rate = max(deriv_percap_hr[smoothed > 0.005], na.rm = TRUE))
head(example_data_and_designs_sum)
```

Now all of our growth rates seem reasonable! How can we calculate the lag time (the time when those peaks occurred)? We can use the `which.max` command, which returns the index of the maximum value, to get the index of the `Time` when the maximum occurs:

```{r}
example_data_and_designs_sum <-
  summarize(grouped_example_data_and_designs,
            growth_rate = max(deriv_percap_hr[smoothed > 0.005], na.rm = TRUE),
            lag_time = Time[which.max(deriv_percap_hr[smoothed > 0.005])])
head(example_data_and_designs_sum)
```

That looks great! Although, Well B10 seems like it's growing at it's fastest quite a bit later than the other wells, is something going wrong there? Actually, as we'll see later, that's actually a result! (Spoiler: it has to do with the Phage Added).

## Finding local extrema: peak density and diauxic shifts
...
### Finding the first peak: peak density

One particular special case we're often interested in is the first peak in some set of data. For instance, when bacteria are grown with phages, the density they reach before they start declining due to phage predation can be a measure of their susceptibility to the phage. 
...
Let's plot these points from a few wells to confirm they are what we expect:

```{r}
plot(example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  example_data_and_designs$smoothed[example_data_and_designs$Well == "A1"],
  xlab = "time", ylab = "Smoothed Absorbance", main = "Well A1")
points(
  x = example_data_and_designs_sum$first_peak_x[
    example_data_and_designs_sum$Well == "A1"],
...
```{r}
plot(example_data_and_designs$Time[example_data_and_designs$Well == "A7"],
  example_data_and_designs$smoothed[example_data_and_designs$Well == "A7"],
  xlab = "time", ylab = "Smoothed Absorbance", main = "Well A7")
points(
  x = example_data_and_designs_sum$first_peak_x[
    example_data_and_designs_sum$Well == "A7"],
  y = example_data_and_designs_sum$first_peak_y[
    example_data_and_designs_sum$Well == "A7"],
  pch = 16, cex = 2)
```

Hmmm, in Well A1 `first_peak` worked perfectly well, but in Well A7 it seems to have gotten stuck on some earlier fluctuations. Just like in smoothing, **peak-finding also has tuning parameters**. For `first_peak` and `find_local_extrema`, these are `width_limit_n`, `width_limit` and `height_limit`:
...
If we want `first_peak` to be less sensitive to local peaks, we can increase these parameters (the default setting is `width_limit_n` equal to 20% of the length of `y`, which is ~19 here). Let's try that:
...
That worked great! But what if you want to find an extrema that's *not* the first peak? In the next section, we'll learn how to use `find_local_extrema` to identify all kinds of local extrema.
...
Let's dig into an example: identifying diauxic shifts. To refresh your memory on what we saw in the section [A simple derivative], here's a plot of the derivative of Well A1 over time.
...
Here we can clearly see there is a second, slower, burst of growth after the first wave of growth. Such a pattern is common in bacterial growth curves and is called *diauxic growth*.
...
example_data_and_designs_sum <-
  summarize(
    grouped_example_data_and_designs,
    diauxie_x = find_local_extrema(x = Time, y = deriv, return = "x",
...
plot(example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  ...
  xlab = "time", ylab = "derivative (Absorbance/sec)")
abline(
  v = example_data_and_designs_sum$diauxie_x[
    example_data_and_designs_sum$Well == "A1"])
```
...
#Now let's plot it on the original density data
plot(example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  example_data_and_designs$smoothed[example_data_and_designs$Well == "A1"],
  xlab = "time", ylab = "Smoothed Absorbance", main = "Well A1")
points(
  x = example_data_and_designs_sum$diauxie_x[
    example_data_and_designs_sum$Well == "A1"],
  y = example_data_and_designs_sum$diauxie_dens[
    example_data_and_designs_sum$Well == "A1"],
  pch = 16, cex = 2)
```
...
### Combining subsets and local extrema: growth rate during diauxie
...
example_data_and_designs_sum <-
  summarize(
    ...
    diauxie_x = find_local_extrema(x = Time, y = deriv, return = "x",
                                   return_maxima = FALSE, return_minima = TRUE,
                                   width_limit_n = 39)[2],
    diauxie_percap = max(deriv_percap_hr[Time >= diauxie_x], na.rm = TRUE),
    diauxie_percap_time = 
      Time[Time >= diauxie_x][which.max(deriv_percap_hr[Time >= diauxie_x])])

#Plot per-capita growth with a point at diauxie_percap_time, diauxie_percap
plot(
  example_data_and_designs$Time[example_data_and_designs$Well == "A1"],
  example_data_and_designs$deriv_percap_hr[
    example_data_and_designs$Well == "A1"],
  xlab = "time", ylab = "per-capita growth rate (/hr)",
  main = "Well A1")
points(
  x = example_data_and_designs_sum$diauxie_percap_time[
    example_data_and_designs_sum$Well == "A1"],
  y = example_data_and_designs_sum$diauxie_percap[
    example_data_and_designs_sum$Well == "A1"],
  pch = 16, cex = 2)
```

## Finding threshold-passing events: extinction time

When bacteria are grown with phages, one common metric for sensitivity to the phage is extinction time. Often, this is defined as the amount of time that passes before the bacterial population rises and then falls below some threshold. [rest of section to be written]
...
Let's use the `example_data_and_designs_sum` from an earlier section, where we've summarized our growth curves using area-under-the-curve (although this approach would work with any number of summarized metrics). 
